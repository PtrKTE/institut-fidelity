...
@section('content')
<h4 class="mb-3"><i class="fas fa-chart-pie me-2"></i>Dashboard</h4>
...
{{-- Stats cards Row 2 --}}
<div class="row g-2 mt-1 fid-stagger">
    <div class="col-md-4">
        <div class="fid-card fid-stat">
    ...
    <div class="col-md-4">
        <div class="fid-card fid-stat">
            ...
            <div class="fid-stat-body">
                <div class="fid-stat-value fid-skeleton fid-skeleton-text" id="topOp" style="font-size:0.9rem;">—</div>
...
$.get("{{ url('/api/stats/ca-jour') }}", function(d) {
    new Chart(document.getElementById('chartCaJour'), {
        type: 'line',
        data: { labels: d.labels.slice(-30), datasets: [{ label: 'CA (F)', data: d.data.slice(-30), borderColor: '#c4226e', backgroundColor: 'rgba(196, 34, 110, 0.1)', fill: true, tension: 0.3 }] },
