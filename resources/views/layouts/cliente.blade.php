...
<head>
    ...
    <link rel="icon" href="{{ url('/public/img/lgp.png') }}">
    <link rel="apple-touch-icon" href="{{ url('/public/img/icon-192.png') }}">

    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@400;500;600;700&display=swap" rel="stylesheet">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css" rel="stylesheet">
    <link href="{{ url('/public/css/design-system.css') }}" rel="stylesheet">
    <link href="{{ url('/public/css/components.css') }}" rel="stylesheet">
    <link href="{{ url('/public/css/animations.css') }}" rel="stylesheet">
    <link href="{{ url('/public/css/cliente.css') }}" rel="stylesheet">
    @stack('styles')
</head>
<body>
    ...
    <div class="pwa-install-banner" id="pwaBanner">
        <img src="{{ url('/public/img/lgp.png') }}" class="pwa-icon" alt="ProNails">
        <div class="pwa-text">
    ...
    if ('serviceWorker' in navigator) {
        navigator.serviceWorker.register('{{ url("/public/sw.js") }}', { scope: '{{ url("/espace-cliente") }}/' })
